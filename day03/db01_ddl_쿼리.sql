...
-- 데이터 베이스 생성(CharSet, Collation 지정)
...
-- 테이블 생성
-- 3-34 NewBook 테이블을 생성하세요. 정수형은 Integer사용, 문자형은 가변형인 Varcher를 사용하십시오.
-- 기본키를 설정합니다.
...
-- address - VARCHER(255) NOT NULL
-- phone - VARCHER(30) NOT NULL
...
-- custid - integer , not null, KF(NewCustomer custid)
-- orderdate - date
...
-- ALTER 
-- NewBook 테이블에 varcher(13)의 isbn 속성을 추가하시오.
ALTER TABLE NewBook ADD isbn VARCHAR(13);

-- 3-38 NewVBook에 isbn 데이터 타입을 integer로 변경하시오.
ALTER TABLE NewBook MODIFY isbn INTEGER;

-- 3-38 NewVBook에 publiser의 제약사항을 NOT NULL로 변경합니다.
