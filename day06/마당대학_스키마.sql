...
-- Table `mydb`.`wrok_in`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`wrok_in` (
  `professorssn` INT NOT NULL,
  `pid` INT NOT NULL,
  PRIMARY KEY (`professorssn`, `pid`),
  INDEX `fk_wrok_in_Project1_idx` (`pid` ASC) VISIBLE,
  CONSTRAINT `fk_wrok_in_professor1`
    FOREIGN KEY (`professorssn`)
    REFERENCES `mydb`.`Professor` (`ssn`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_wrok_in_Project1`
    FOREIGN KEY (`pid`)
